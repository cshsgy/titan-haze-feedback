...
order (a few $\mathrm{K}$ per Titan day). Relaxing level temperatures along the
net heating rate (per-level, under-relaxed, surface held fixed) cuts the bulk
net-heating residual by roughly an order of magnitude and yields a recognizably
